...
For more Information, please see the following page:
 - [Install Fluidsynth](https://www.fluidsynth.org/wiki/Download)

### Build from Source

Depending on your platform and distribution, you might need to build FluidSynth yourself to use the
most up-to-date version.
 - [Build with CMake](https://www.fluidsynth.org/wiki/BuildingWithCMake)
 - [Build for Android](https://www.fluidsynth.org/wiki/BuildingForAndroid)
